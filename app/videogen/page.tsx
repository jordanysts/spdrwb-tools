                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                            ...
                            AI Video Tool
                            {credits !== null && (
                                <span className="ml-2 px-2 py-0.5 bg-orange-100 border border-orange-200 rounded text-gray-900 text-xs font-medium">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                            ...
                            <select
                                ...
                                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-3 text-sm text-gray-900 focus:outline-none focus:border-gray-800 transition-colors"
                            >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-2 py-2 text-sm text-gray-900 focus:outline-none focus:border-gray-800"
                                    >
                                ...
                                <div className="mt-4">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            className="w-4 h-4 rounded border-gray-300 bg-gray-50 text-gray-800 focus:ring-gray-800"
                                        />
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                            ...
                            <textarea
                                ...
                                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-800 min-h-[100px] resize-none"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gray-800 hover:bg-gray-900 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-900/10"
                        >
                            {loading ? (
                                <>
                            ...
                            <div className="px-4 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
                                ...
                                {resultVideo && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="text-gray-900 hover:text-gray-800 text-xs font-medium flex items-center gap-1"
                                    >
