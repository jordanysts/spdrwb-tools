        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
                <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                    ...
                    <div
                        className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors cursor-pointer ${file ? "border-gray-800 bg-orange-50" : "border-gray-300 hover:border-gray-400 hover:bg-gray-50"
                            }`}
                    ...
                    >
                        ...
                        {file ? (
                            <div className="flex flex-col items-center">
                                <FileAudio className="w-12 h-12 text-gray-900 mb-3" />
