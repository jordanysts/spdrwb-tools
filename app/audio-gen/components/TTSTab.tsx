            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                    ...
                    <select
                        ...
                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:border-gray-800 transition-colors"
                    >
                        {voices.map((voice) => (
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                    ...
                    <textarea
                        ...
                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-800 min-h-[200px] resize-none"
                        maxLength={5000}
                    />
