        ...
        <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Audio Editor</h1>
                </div>
                        ...
                        {batchFiles.length > 0 && (
                            <div className="bg-gray-100 rounded-lg border border-gray-200 p-4 space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full py-3 bg-gray-800 hover:bg-gray-900 disabled:bg-white disabled:text-gray-500 disabled:cursor-not-allowed rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-white"
                                >
                                    {isProcessingBatch ? (
                                        <>
                                ...
                                {batchFiles.some(f => f.status === 'complete') && (
                                    <button
                                        ...
                                        className="w-full py-3 bg-gray-800 hover:bg-gray-900 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-white"
                                    >
                                        ...
                                        <div key={file.id} className="p-3 bg-white rounded">
                                            <div className="flex justify-between items-center mb-1">
                                                ...
                                                <span className={`text-xs ml-2 ${file.status === 'complete' ? 'text-green-400' :
                                                    file.status === 'error' ? 'text-red-400' :
                                                        file.status === 'processing' ? 'text-gray-900' :
                                                            'text-gray-500'
                                                    }`}>
                                                    {file.status}
                                                </span>
                                            ...
                                            {file.status === 'processing' && (
                                                <div className="w-full bg-gray-50 rounded h-1 mt-2">
                                                    <div
                                                        className="bg-gray-800 h-full rounded transition-all"
                                                    ...
                                                    {file.outputSize && (
                                                        <div className="p-2 bg-gray-100 rounded text-xs space-y-0.5 mt-2">
                                                            ...
                                                            <div className="flex justify-between">
                                                                ...
                                                                <span className={file.outputSize < 300000 ? 'text-green-400' : 'text-gray-900'}>
                                                                    {formatFileSize(file.outputSize)}
                                                                </span>
                                                            </div>
                                                            {file.outputSize >= 300000 && (
                                                                <p className="text-gray-900 text-xs mt-1">⚠️ &gt;300KB</p>
                                                            )}
                                                        </div>
                                                    )}
                                                    <a
                                ...
                                >
                                    ...
                                    {audioFile ? (
                                        <div className="w-full text-center">
                                            <Music className="w-8 h-8 mx-auto text-gray-800 mb-2" />
                                ...
                                <div className="bg-gray-100 rounded-lg border border-gray-200 p-4 space-y-4">
                                    ...
                                    <div className="flex items-center justify-between pt-2 border-t border-zinc-800">
                                        ...
                                        <button
                                            ...
                                            className={`w-11 h-6 rounded-full transition-colors relative ${normalize ? 'bg-gray-800' : 'bg-gray-50'}`}
                                        >
                                    ...
                                    <div className="grid grid-cols-2 gap-3 pt-2 border-t border-zinc-800">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-white border border-gray-300 rounded px-2 py-1.5 text-sm text-gray-900 focus:outline-none focus:border-gray-800"
                                            >
                                ...
                                <div className="bg-gray-100 rounded-lg border border-gray-200 p-4">
                                    ...
                                    >
                                        <div className="absolute inset-0 flex items-center justify-around px-1">
                                            {visibleWaveformData.map((amplitude, i) => {
                                                ...
                                                return (
                                                    <div
                                                        key={i}
                                                        className={`w-1 rounded-full transition-colors ${isSelected ? 'bg-gray-800' : 'bg-zinc-400'}`}
                                        ...
                                        {zoomedEndPercent > 0 && zoomedStartPercent < 100 && (
                                            <div
                                                className="absolute top-0 bottom-0 bg-gray-800/10 border-l-2 border-r-2 border-gray-800"
                                                style={{
                                    ...
                                    <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-200">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <span className="text-sm font-medium text-gray-900">{formatTime(endTime - startTime)}</span>
                                        </div>
                            ...
                            <div className="bg-gray-100 rounded-lg border border-gray-200 overflow-hidden min-h-[400px]">
                                ...
                                <div className="p-6 flex flex-col items-center justify-center min-h-[350px] bg-white">
                                    {isProcessing ? (
                                        ...
                                        <div className="w-full text-center">
                                            <Music className="w-10 h-10 mx-auto text-gray-800 mb-3" />
                                            ...
                                            {outputFileSize > 0 && (
                                                <div className="p-3 bg-zinc-100 rounded text-sm space-y-1 mb-4 text-left">
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className={`font-medium ${outputFileSize < 300000 ? 'text-gray-900' : 'text-gray-800'}`}>
                                                            {formatFileSize(outputFileSize)}
                                                        </span>
                                                    </div>
                                                    {outputFileSize >= 300000 && (
                                                        <p className="text-xs text-gray-900 mt-2 pt-2 border-t border-zinc-200">
                                            ...
                                            <button
                                                onClick={downloadOutput}
                                                className="px-6 py-2 bg-gray-800 hover:bg-gray-900 rounded-lg font-medium transition-colors inline-flex items-center gap-2 text-white"
                                            >
                                                <Download className="w-4 h-4" />
