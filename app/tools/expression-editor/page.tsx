    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-orange-600">Expression Editor</h1>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="px-4 pb-4 flex gap-4">
              ...
              <button
                ...
                className="flex-1 py-3 bg-orange-600 hover:bg-orange-500 disabled:bg-white disabled:text-gray-500 disabled:cursor-not-allowed rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
              >
                {isGenerating ? (
                  <>
            ...
            {outputImage && (
              <div className="px-4 pb-4">
                <button
                  ...
                  className="w-full py-2.5 bg-orange-600 hover:bg-orange-500 disabled:bg-white disabled:text-gray-500 disabled:cursor-not-allowed rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-sm"
                >
                  {isCompositing ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm items-center">
                      ...
                      <input
                        ...
                        className="w-16 bg-white border border-gray-200 rounded px-2 py-0.5 text-right text-sm text-gray-700 focus:outline-none focus:border-orange-500"
                      />
                    </div>
                    <input
                      type="range"
                  ...
                  <div className="mt-6 pt-6 border-t border-zinc-800 space-y-3">
                    <button
                      ...
                      className={`w-full py-2 rounded text-sm transition-colors flex items-center justify-center gap-2 ${isComparing
                        ? 'bg-orange-600 text-gray-900 hover:bg-orange-700'
                ...
                {isComparing && inputImage ? (
                  comparisonMode === 'slider' ? (
                    ...
                    <div className="flex gap-2 h-full w-full">
                      ...
                      <div className="flex-1 min-w-0 bg-zinc-100 rounded-lg overflow-hidden relative">
                        <span className="absolute top-2 left-2 bg-orange-500/80 text-gray-900 px-2 py-0.5 text-[10px] rounded backdrop-blur-sm z-10">Result</span>
