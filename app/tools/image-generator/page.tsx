        ...
        <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-orange-600">AI Image Generator</h1>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gray-100 rounded-lg border border-gray-200 overflow-hidden p-6 space-y-4">
                            ...
                            <textarea
                                ...
                                className="w-full h-32 bg-white border border-gray-300 rounded px-3 py-2 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:border-orange-500 resize-none"
                            />

                            <div className="flex justify-between items-center">
                                {prompt.includes('[SUBJECT]') && (
                                    <p className="text-xs text-orange-600">💡 Replace [SUBJECT] with your description</p>
                                )}
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-orange-600 hover:bg-orange-500 disabled:bg-white disabled:text-gray-500 disabled:cursor-not-allowed rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-white"
                        >
                            {isGenerating ? (
                                <>
