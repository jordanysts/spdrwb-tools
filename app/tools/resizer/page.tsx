        ...
        <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-orange-600">Image Resizer</h1>
                </div>
                                                ...
                                                <div className="flex-1 min-w-0 mr-3">
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <span className={`text-[10px] px-1.5 py-0.5 rounded uppercase font-medium ${file.status === 'complete' ? 'bg-green-900/50 text-green-400' :
                                                            file.status === 'processing' ? 'bg-orange-900/50 text-orange-600' :
                                                    ...
                                                    {file.status === 'processing' && (
                                                        <div className="w-full bg-gray-50 rounded-full h-1 mt-2">
                                                            <div className="bg-orange-500 h-1 rounded-full transition-all duration-300" style={{ width: `${file.progress}%` }} />
                                                        </div>
                                                    )}
                                                </div>
                                                {file.status === 'pending' && (
                            ...
                            <div className="flex border-b border-gray-200">
                                <button
                                    ...
                                    className={`flex-1 py-3 px-4 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeTab === 'optimize'
                                        ? 'bg-orange-50 text-orange-600 border-b-2 border-orange-400'
                                        ...
                                        {inputImage ? (
                                            <>
                                                <button
                                                    ...
                                                    className="w-full py-3 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                                                >
                                                    {isOptimizing ? (
                                                        <>
                                ...
                                <div className="bg-gray-100 rounded-lg border border-gray-200 p-6">
                                    ...
                                    <div className="space-y-3">
                                        <button
                                            ...
                                            className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed text-gray-900 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                                        >
                                            {isProcessingBatch ? (
                                    ...
                                    <div className="bg-gray-100 rounded-lg border border-gray-200 overflow-hidden">
                                        <div className="px-4 py-2 bg-white border-b border-gray-200 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {isProcessing && (
                                                    <span className="text-xs text-orange-600 animate-pulse">Processing...</span>
                                                )}
                                            </div>
                                            {processedImage && (
                                                <button
                                ...
                                {activeTab === 'optimize' && optimizedImage && (
                                    <div className="bg-gray-100/50 rounded-lg border border-orange-200 p-6">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h3 className="text-sm font-medium text-orange-600">Optimization Complete</h3>
                                        </div>
