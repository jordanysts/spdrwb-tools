        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-900 focus:outline-none focus:border-orange-500"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-900 focus:outline-none focus:border-orange-500 min-h-[80px] resize-none"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="w-full py-2.5 bg-orange-600 hover:bg-orange-500 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                        >
                            {isCloning ? (
                                <>
            ...
            <div className="space-y-6">
                <div className="bg-orange-50 rounded-lg border border-orange-100 p-6">
                    ...
                    <ul className="space-y-2 text-sm text-orange-900 list-disc pl-4">
