        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <textarea
                                            ...
                                            rows={1}
                                            className="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm focus:border-orange-500 focus:outline-none resize-none overflow-hidden"
                    ...
                    <button
                        onClick={addLine}
                        className="mt-6 w-full py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-500 hover:border-orange-500 hover:text-orange-500 transition-colors flex items-center justify-center gap-2 text-sm font-medium"
                    >
