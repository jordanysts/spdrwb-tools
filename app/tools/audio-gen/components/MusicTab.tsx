            ...
            <div className="space-y-6">
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                    ...
                    <textarea
                        ...
                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500 min-h-[120px] resize-none"
                    />
                            ...
                            <div className="w-full max-w-md space-y-4">
                                ...
                                <div className="relative w-48 h-48 mx-auto mb-6">
                                    <div className={`w-full h-full rounded-full bg-gray-900 flex items-center justify-center shadow-xl border-4 border-gray-800 ${isPlaying ? 'animate-[spin_4s_linear_infinite]' : ''}`}>
                                        <div className="w-1/3 h-1/3 rounded-full bg-orange-500 flex items-center justify-center border-4 border-orange-600">
                                ...
                                <div className="bg-white rounded-lg p-6 shadow-md">
                                    <div className="flex items-center justify-center mb-4">
                                        <button
                                            ...
                                            className="w-16 h-16 bg-orange-600 hover:bg-orange-500 rounded-full flex items-center justify-center transition-colors shadow-lg"
                                        >
                                            {isPlaying ? (
