          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-100 rounded-lg border border-gray-200 p-4">
              ...
              <textarea
                ...
                className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder-zinc-500 focus:outline-none focus:border-gray-800 min-h-[80px] resize-none"
              />
            </div>
              ...
              <div className="p-6 flex flex-col items-center justify-center min-h-[350px] bg-white">
                {isGenerating ? (
                  ...
                  <div className="w-full text-center">
                    ...
                    <button
                      onClick={downloadVideo}
                      className="mt-4 px-6 py-2 bg-gray-900 hover:bg-gray-800 rounded-lg font-medium transition-colors inline-flex items-center gap-2 text-gray-900"
                    >
