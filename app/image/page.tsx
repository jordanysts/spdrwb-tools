          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-gray-900" /> Iterative Edit
              </h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <textarea
                ...
                rows={2}
                className="w-full bg-white border border-gray-200 rounded-lg p-3 text-sm text-gray-900 focus:border-gray-800 focus:ring-1 focus:ring-gray-800 outline-none resize-none transition pr-12"
                placeholder="Type edits here..."
              />
              <button
                onClick={generateImage}
                disabled={!prompt.trim() || isGenerating || !currentActiveId}
                className="absolute right-2 bottom-2 p-2 bg-gray-900 hover:bg-gray-800 rounded-md text-white disabled:opacity-50 disabled:cursor-not-allowed transition"
              >
